...
public class Kafka2KuduOrderBuyTmp {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final String appname = "sku_order_buy_refund_kudu_de_tmp";
		final String topic = "Baby-DataSys-0002";
		final String groupId = "Baby-DataSys-0002-3";
		final String tablename = "event.event_baby_sku_order_kudu_de_tmp";
	...
	private static JSONObject mappingData(List<Map<String, Object>> columnList, JSONObject jsonData) throws ParseException {
		...
		String saleTime = jsonData.getString("saleTime");
		try {
			new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(saleTime);
		} catch (Exception e) {
			System.out.println("日期类型有误：" + saleTime);
			return mappingData;
		}
		for(Map<String, Object> column : columnList){
			String columnName = column.get("column").toString();
//			if("".equals(jsonData.getString("saleTime")) || "2018-09-01".compareTo(jsonData.getString("saleTime"))> 0){
//				return mappingData;
//			}
