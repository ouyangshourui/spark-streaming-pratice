...
public class SparkReadHiveTTrade2HBase {
    public static void main(String[] args) throws  Exception {
        String hbaseTable = "t_trade";
        String[] rowkeyarray = {"fdeal_id", "_fbdeal_id", "_ftenancy_id", "_fbuyer_id","_ftrade_id"};
        String hivesql = "select * from fdm.fdm_oms_orders_t_trade_chain where dp='active'";
...
//        HBaseUtil.getInstance().insertData(hbaseTable,"info", rowkeydataMap);
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("SparkReadHiveTTtade2HBase")
                .enableHiveSupport()
                .getOrCreate();
