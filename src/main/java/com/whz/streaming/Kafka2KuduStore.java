...
public class Kafka2KuduStore {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		final String appname = "event_baby_store_store_dim";
		final String topic = "Baby-DataSys-0002";
		final String groupId = "Baby-DataSys-0002-5";
		final String tablename = "event.event_baby_store_store_dim";
		final int validType = 5;
	...
	private static JSONObject mappingData(List<Map<String, Object>> columnList, JSONObject jsonData) throws ParseException {
		...
		for(Map<String, Object> column : columnList){
			...
			if("k_ftenancy_id".equals(columnName)){
				String value = jsonData.getString("cal_platformNum");
				mappingData.put(columnName, value);
			}else if("storecode".equals(columnName)){
				String value = jsonData.getString("storeCode");
				mappingData.put(columnName, value);
			}else if("address_street".equals(columnName)){
				String value = jsonData.getString("address_street");
				mappingData.put(columnName, value);
			}else if("spell".equals(columnName)){
				String value = jsonData.getString("spell");
				mappingData.put(columnName, value);
			}else if("province".equals(columnName)){
				String value = jsonData.getString("province");
				mappingData.put(columnName, value);
			}else if("storename".equals(columnName)){
				String value = jsonData.getString("storeName");
				mappingData.put(columnName, value);
			}
		}
		return mappingData;
