...
public class Kafka2TidbUser_bak {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		final String[] primarykey = {"k_ftenancy_id","k_fid"};
        ...
        tranfDStream.foreachRDD(rdd -> {
        	rdd.foreachPartition(partition -> {
        		...
        		while(partition.hasNext()){
					listSaveHandler(partition.next(),tablename,util,primarykey);
				}
        	});
        });
        
//        tranfDStream.foreachRDD(new VoidFunction<JavaRDD<JSONObject>>() {
//			private static final long serialVersionUID = -3994731922854368879L;
//
//			@Override
//			public void call(JavaRDD<JSONObject> t) throws Exception {
////				long tcount=t.count();
////				t.repartition(((int)tcount/5000) + 1);
//				
//				t.foreachPartition(new VoidFunction<Iterator<JSONObject>>() {
//					
//					private static final long serialVersionUID = 1L;
//					@Override
//					public void call(Iterator<JSONObject> f) throws Exception {
//						while(f.hasNext()){
//							listSaveHandler(f.next(),tablename,jdbcModel,primarykey);
...
//		}
	...
	public static void listSaveHandler(JSONObject result,String tableName,JdbcUtils util,String[] primarykey){
